...
class ResidualAttentionBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        att_x, att_weights = self.attention(self.ln_1(x))
...
class VisionTransformerConfig(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.input_resolution = kwargs.get("input_resolution", 224)
        self.patch_size = kwargs.get("patch_size", 16)
        self.width = kwargs.get("width", 768)
        self.layers = kwargs.get("layers", 12)
        self.heads = kwargs.get("heads", 12)
        self.output_dim = kwargs.get("output_dim", 1000)


class VisionTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, output_dim: int):
        super().__init__()
        self.config = VisionTransformerConfig(input_resolution=input_resolution,
